...
def main():
    ...
    print("\n \nTo show the effectiveness of our creative evaluation metric, below please find every score generated by our program.")
    print("It is a list of lists, where each element is the scores from a single generation. The first score of every generation is the average")
    print(" score for that generation.")
    print(mypop.full_score_sheet)
